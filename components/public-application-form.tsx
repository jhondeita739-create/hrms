    ...
    return (
      <div className="rounded-2xl border border-blue-200 bg-brand-50 p-6 sm:p-8">
        ...
        <div className="mt-6 rounded-xl border border-blue-200 bg-white p-4">
          ...
          <div className="mt-1 break-all font-mono text-base font-semibold text-brand-900">{state.reference}</div>
        </div>
    ...
    <form action={action} className="space-y-5">
      ...
      <fieldset className="rounded-3xl border border-slate-200/80 bg-white p-5 shadow-[0_6px_24px_rgb(15,23,42,0.03)] sm:p-7">
        ...
        <div className="mt-6">
          ...
          <label className="group mt-2 flex cursor-pointer flex-col gap-4 rounded-2xl border border-dashed border-slate-300 bg-slate-50/80 p-4 transition-all hover:border-brand-400 hover:bg-brand-50/60 sm:flex-row sm:items-center sm:p-5">
            ...
            <span className="inline-flex h-10 w-full items-center justify-center rounded-full border border-slate-200 bg-white px-4 text-xs font-bold text-slate-700 shadow-sm group-hover:text-brand-700 sm:w-auto">
      ...
      <div className="flex flex-col gap-4 rounded-2xl border border-slate-200 bg-white p-5 shadow-[0_8px_24px_rgb(15,23,42,0.04)] sm:flex-row sm:items-center sm:justify-between">
        <span className="flex items-start gap-2 text-[11px] leading-5 text-slate-400 sm:items-center">
          <LockKeyhole className="mt-0.5 h-3.5 w-3.5 shrink-0 sm:mt-0" /> Your application and PDF are stored privately.
        </span>
        <SubmitButton />
      </div>
    </form>
