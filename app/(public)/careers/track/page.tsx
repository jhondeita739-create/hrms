...
export default function TrackApplicationPage() {
  return (
    <main className="relative min-h-[calc(100vh-80px)] overflow-hidden bg-[#FAFBFF] selection:bg-brand-200">
      ...
      <div className="relative z-10 mx-auto w-full max-w-5xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8 lg:py-20">
        ...
        <div className="grid gap-8 sm:gap-12 lg:grid-cols-[1fr_1.2fr] lg:items-center">
          <div>
            <span className="grid h-14 w-14 place-items-center rounded-2xl bg-brand-50 text-brand-600 shadow-sm sm:h-16 sm:w-16">
              <ShieldCheck className="h-7 w-7 sm:h-8 sm:w-8" />
            </span>
            <h1 className="mt-6 text-3xl font-extrabold tracking-tight text-slate-900 sm:mt-8 sm:text-5xl">Track your application.</h1>
          ...
          <div className="min-w-0 rounded-[2rem] border border-white/60 bg-white/60 p-3 shadow-2xl shadow-indigo-900/10 backdrop-blur-2xl sm:rounded-[2.5rem] sm:p-10">
            <ApplicationTracker />
          </div>
        </div>
      </div>
